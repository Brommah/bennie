...
// =============================================================================
// SUBTLE SVG POLISH COMPONENTS - Accents only, not replacing content
// =============================================================================

/** Animated Waveform - for audio preview sections */
const WaveformAccent: React.FC<{ color?: string }> = ({ color = '#84cc16' }) => {
  const [bars, setBars] = useState<number[]>(Array(30).fill(0.3));

  useEffect(() => {
    const interval = setInterval(() => {
      setBars(Array(30).fill(0).map(() => 0.15 + Math.random() * 0.85));
    }, 120);
...
const CornerBrackets: React.FC<{ color?: string }> = ({ color = '#84cc16' }) => (
  <>
    <div className="absolute top-0 left-0 w-4 h-4 border-l-2 border-t-2 opacity-40" style={{ borderColor: color }} />
    <div className="absolute top-0 right-0 w-4 h-4 border-r-2 border-t-2 opacity-40" style={{ borderColor: color }} />
    <div className="absolute bottom-0 left-0 w-4 h-4 border-l-2 border-b-2 opacity-40" style={{ borderColor: color }} />
    <div className="absolute bottom-0 right-0 w-4 h-4 border-r-2 border-b-2 opacity-40" style={{ borderColor: color }} />
  </>
);

/** Subtle grid background */
const GridAccent: React.FC = () => (
  <div 
...
/** Pulsing status dot */
const StatusDot: React.FC<{ active?: boolean }> = ({ active = true }) => (
  <span className="relative flex h-2 w-2">
    {active && <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-acid opacity-75" />}
    <span className={`relative inline-flex rounded-full h-2 w-2 ${active ? 'bg-acid' : 'bg-zinc-600'}`} />
  </span>
);
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-[9px] font-mono text-zinc-400 group-hover:text-acid flex items-center gap-1">
                              <StatusDot /> CONNECTED
                            </div>
                        </div>
                    </div>
    ...
    <div className="flex flex-col h-full bg-zinc-950 font-sans text-white relative">
        ...
        <div className="px-5 flex-1 overflow-y-auto pb-24">
            <div className="flex justify-between items-end mb-3">
                ...
                <span className="text-[10px] font-mono text-acid border border-acid/50 px-1.5 py-0.5 bg-acid/10">CONFIDENCE: 99%</span>
            </div>
            
            <div className="bg-zinc-900 border border-zinc-800 rounded-sm overflow-hidden group hover:border-acid transition-colors shadow-xl relative">
                <CornerBrackets />
...
export const MatchingScreen = () => (
    <div className="flex flex-col h-full bg-zinc-950 font-sans text-white relative">
        <div className="pt-14 px-5 mb-4">
             ...
             <p className="text-[10px] font-mono text-zinc-400 uppercase tracking-widest mt-1 flex items-center gap-2">
                <StatusDot /> Data Sovereignty: Active
             </p>
        </div>
    ...
    <div className="flex flex-col h-full bg-zinc-950 font-sans text-white relative">
        ...
        <div className="relative z-10 pt-48 px-6 flex-1 flex flex-col">
             ...
             <div className="space-y-6">
                 <div className="bg-zinc-900/80 p-3 border-l-2 border-acid shadow-lg relative">
                     <CornerBrackets />
                 ...
                 {/* Audio Fingerprint Visualizer - POLISHED */}
                 <div className="bg-zinc-900 border border-zinc-800 p-3 rounded-sm relative overflow-hidden">
                     <CornerBrackets />
  ...
  <div className="flex flex-col h-full bg-zinc-950 font-sans text-white relative overflow-hidden">
    ...
    <div className="relative z-10 pt-14 px-5 h-full flex flex-col">
        ...
        <div className="space-y-3">
             <div className="bg-zinc-900/80 border border-zinc-700 p-4 backdrop-blur-sm group hover:border-acid transition-colors shadow-lg relative">
                  <CornerBrackets />
...
export const VaultScreen = () => (
  <div className="flex flex-col h-full bg-zinc-950 font-sans text-white relative">
    ...
    <div className="px-5 space-y-4 relative z-10">
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 p-4 mt-8 relative">
             <CornerBrackets />
             <div className="flex justify-between items-center mb-2">
...
export const SignalScreen = () => (
  <div className="flex flex-col h-full bg-zinc-950 font-sans text-white relative">
    ...
    <div className="px-5 space-y-3 relative z-10">
        <div className="bg-white text-black p-4 border border-zinc-200 shadow-[0_0_15px_rgba(255,255,255,0.1)] relative">
             <CornerBrackets color="#000" />
             <div className="flex gap-3 mb-3">
                  <div className="w-8 h-8 border border-black flex items-center justify-center overflow-hidden">
                    <img src="https://i.pravatar.cc/150?u=Sarah" className="w-full h-full grayscale" />
                  </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 p-4 relative">
             ...
             <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                      <div className="text-[9px] font-bold uppercase text-acid mb-1 flex items-center gap-1">
                        <StatusDot /> Early Access
                      </div>
